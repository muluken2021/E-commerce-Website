  ...
  return (
   ...
   <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <motion.div
          ...
          className="md:col-span-1 md:row-span-2 relative rounded-3xl overflow-hidden group"
        >
          <Link to="/category/fashion">
            ...
            <div className="absolute bottom-8 left-8 flex items-center gap-4">
              ...
              <div className="p-2 bg-brand-500 rounded-lg text-white"><ArrowRight size={20} /></div>
            </div>
          </Link>
        </motion.div>
        ...
        <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
          {cats.map((cat, i) => (
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden group h-[290px]"
            >
              <Link to={cat.path}>
                ...
                <div className="absolute bottom-6 left-6 flex items-center gap-4">
                  ...
                  <div className="p-2 bg-brand-500 rounded-lg text-white"><ArrowRight size={16} /></div>
                </div>
              </Link>
            </motion.div>
          ))}
