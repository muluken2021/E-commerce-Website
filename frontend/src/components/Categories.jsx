...
const Categories = () => {
  const cats = [
    { name: "Electronics", img: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500", color: "bg-purple-500", size: "col-span-1" },
    { name: "Beauty Products", img: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=500", size: "col-span-1" },
    { name: "Furnitures", img: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=500", size: "col-span-1" },
    { name: "Music", img: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500", size: "col-span-1" },
  ];
