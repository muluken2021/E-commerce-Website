...
export default function InstagramGallery() {
  // Grab items with a gap of 3 to create a varied selection from your dataset
    ...
    <section className="w-full bg-white py-16">
      ...
      <div className="text-center mb-12 max-w-xl mx-auto px-4">
        ...
        <p className="text-xs md:text-sm text-gray-400 mt-3 leading-relaxed">
          Explore our latest customer spotlights and traditional hand-loomed styles featured on our social channels.
        </p>
      </div>
