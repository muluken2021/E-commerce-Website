        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="bg-orange-500 p-1.5 rounded-lg text-white font-bold italic">S</div>
            ...
            <div className="flex gap-2">
              ...
              <button className="bg-[#fb923c] text-white px-4 py-2.5 rounded-lg text-xs font-bold">Suscribe</button>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600 font-medium">
              ...
              <li className="hover:text-orange-500 cursor-pointer">Shop Now</li>
            </ul>
          </div>
